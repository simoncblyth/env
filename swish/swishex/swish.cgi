...
#
#    swish.cgi $Revision: 1.22 $ Copyright (C) 2001 Bill Moseley swishscript@hank.org
...
sub default_config {
    ...
    return {
        title           => 'Search Daya Bay site',  # Title of your choice.  Displays on the search page
...
swish.cgi $Revision: 1.22 $ Copyright (C) 2001 Bill Moseley search@hank.org
Example CGI program for searching with SWISH-E
