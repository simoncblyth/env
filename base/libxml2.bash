...
# on leopard looks the same :
#
# Making all in python
# Making all in .
# /usr/bin/python ./generator.py .
# /System/Library/Frameworks/Python.framework/Versions/2.5/lib/python2.5/xmllib.py:9: DeprecationWarning: The xmllib module is obsolete.  Use xml.sax instead.
#  warnings.warn("The xmllib module is obsolete.  Use xml.sax instead.", DeprecationWarning)
# Found 1595 functions in libxml2-api.xml
# Found 55 functions in libxml2-python-api.xml
# Generated 880 wrapper functions, 555 failed, 215 skipped
...
libxml2-py-pth(){
  ...
  ## invoke with
  ##   sudo bash -lc "libxml2 ; libxml2-py-pth "
  ## when PYTHON_SITE belongs to root
  ##  
  ##
...
libxml2-pyinstall(){
   ...
   # dont bother with this way ...   use the py-pth approach above
