...
epjconf-init()
{
   ...
   if [ -f "$texname" ]; then
       echo $msg texname $texname exists already in $dir
   else
...
epjconf-fdir(){ echo $HOME/simoncblyth.bitbucket.io/env/presentation ; }
epjconf-texinputs(){ echo .:$(epjconf-tdir):$(epjconf-fdir): ; }
...
epjconf-edit(){ vi $(epjconf-etex) ; }
epjconf-e(){    vi $(epjconf-etex) ; }
