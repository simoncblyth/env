...
Testing as Geometry and Models continue to Evolve
---------------------------------------------------
...
and the line segment where to generate them. 

The Opticks CUDA launch conceptually simulates all optical photons in parallel, one CUDA thread per optical photon.
