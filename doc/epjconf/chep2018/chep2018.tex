...
%
Opticks\cite{opticksURL}\cite{opticksGroup} enables Geant4\cite{g4A}\cite{g4B}\cite{g4C}
based optical photon simulations to benefit from the high performance massively parallel GPU ray tracing 
provided by the NVIDIA\textregistered\ OptiX\texttrademark\cite{optixPaper}\cite{optixSite}\cite{optixDocs} package.
