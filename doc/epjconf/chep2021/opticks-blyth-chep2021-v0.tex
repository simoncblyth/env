...
1. update Summary
2. trimming the sections
3. optix7 reference
4. reduce to 10 pages by hiving off some sections by referencing 
   the prior proceedings, do this in a what-is-where coordination paragraph 
...
%
%\bibitem{optix7Intro}
%OptiX 7 Introduction {\tt https://developer.nvidia.com/blog/how-to-get-started-with-optix-7/}
%
%
%13
\bibitem{juno}
