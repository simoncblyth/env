...
optixsample1-src(){      echo cuda/optix/optix301/sample1/optixsample1.bash ; }
...
optixsample1-dir(){  echo $(env-home)/cuda/optix/optix301/sample1 ; }
optixsample1-sdir(){ echo $(env-home)/cuda/optix/optix301/sample1 ; }
optixsample1-bdir(){ echo $(local-base)/env/cuda/optix/optix301/sample1 ; }
...
optixsample1-cmake(){
   ...
   cmake $(optixsample1-sdir)/CMakeLists.txt -DCUDA_NVCC_FLAGS="-ccbin /usr/bin/clang"
}
