...
* Recreate Geometry/Material/Surface properties on GPU  

  * export from Geant4 into DAE 3D files, **G4DAE**
  * parse **G4DAE** file into external geometry tree **g4daenode.py** 
