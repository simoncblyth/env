...
from env.opticksnpy.geometry import Boundary
from env.opticksnpy.fresnel import fresnel_factor
from env.opticksnpy.cie import CIE
from env.opticksnpy.droplet import Droplet
...
class Rainbow(object):
    ...
    def __init__(self, evt, boundary, k=1, side=[0,0,1]):
        """
        :param evt: provides evt.whitepoint
        :param boundary:
        :param k: integer picking the number of internal reflections
    ...
    def cieplot_1d(self, b=None, nb=20, ntile=50, norm=2):
        ...
        w = self.w                     # wavelength array
        d = self.dv/deg                # deviation angle in degrees
        db = self.xbow.dbins(nb)/deg   # angle bins
