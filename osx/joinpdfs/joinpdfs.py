...
#
#  https://raw.githubusercontent.com/benwiggy/PDFsuite/master/Automator_Scripts/joinpdfs.py 
#  https://apple.stackexchange.com/questions/230437/how-can-i-combine-multiple-pdfs-using-the-command-line/230447
#
...
def join(incomingFiles):
    ...
    prefix = os.path.dirname(incomingFiles[-1])


    stems = []
    for path in incomingFiles:
