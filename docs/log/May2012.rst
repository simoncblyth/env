...
cron hookup + notification mail (TODO)
----------------------------------------

Adapt root and blyth cronlines from G::

     (export ENV_HOME=/home/blyth/env ; . /home/blyth/env/env.bash ; env- ; scm-backup-  ; scm-backup-rsync ; scm-backup-mail ) > /var/log/cronlog/blyth/scm-backup-rsync.log  2>&1
     (export HOME=/Users/blyth ; export ENV_HOME=/Users/blyth/env ; . /Users/blyth/env/env.bash ; env- ; scm-backup-  ; scm-backup-all ) > /var/log/cronlog/root/scm-backup-all.log 2>&1
