# -*- coding: utf-8 -*-
#
# Env documentation build configuration file, created by
# sphinx-quickstart on Mon May  7 16:20:23 2012.
#
...
html_sidebars = {
		   '**': ['searchbox.html','sidelinks.html', 'sourcelink.html', 'relations.html' ],
		   }
...
latex_documents = [
  ('index', 'Env.tex', u'Env Documentation',
...
texinfo_documents = [
  ('index', 'Env', u'Env Documentation',
   u'Simon C Blyth', 'Env', 'One line description of project.',
   'Miscellaneous'),
]
