...
Geometrical Manipulations Needed for export
---------------------------------------------

All the shapes and boolean combinations thereof being converted into 
...
Output buffering mismatch ? Leaves me uncertain that the error goes with the preceeding volume::
    ...
    SCB ***** AddPrimitive(G4Polyhedron)/dd/Geometry/CalibrationSources/lvWallLedSourceAssy#pvWallLedAcrylicRod.1001
    SCB ***** AddPrimitive(G4Polyhedron)/dd/Geometry/AD/lvOIL#pvWallBotLedSourceAssy.1519
...
Another message going to G4cout, rather than the above going to std::cer::
...
Try using std::cerr for the volnames to match most of the warnings::
