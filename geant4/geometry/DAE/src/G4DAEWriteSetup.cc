...
//
//
// $Id: G4DAEWriteSetup.cc,v 1.11 2008/07/16 15:46:34 gcosmo Exp $
// GEANT4 tag $Name: geant4-09-02 $
//
// class G4DAEWriteSetup Implementation
//
...
void G4DAEWriteSetup::SetupWrite(xercesc::DOMElement* gdmlElement,
                                  const G4LogicalVolume* const logvol)
{
   G4cout << "G4DAE: Writing setup..." << G4endl;
