...
//
//
// $Id: G4DAEWriteParamvol.cc,v 1.23 2008/08/20 08:56:32 gcosmo Exp $
// GEANT4 tag $Name: geant4-09-02 $
//
// class G4DAEParamVol Implementation
//
                ...
                const G4VPhysicalVolume* const paramvol,const G4int& index)
{
   ...
   else
   {
     ...
     G4Exception("G4DAEWriteParamvol::ParametersWrite()",
