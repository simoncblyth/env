...
nuwa-usage(){
  cat << EOU
       ...
       nuwa-pkgdir <pkg>
           returh path of the named package ... the matching is done case-sensitively first   
           and then with all lowercased 

       nuwa-cd <pkg> <sub>
          cd to the pkddir/<sub>  
          this is aliased to ncd
...
nuwa-genpkgdir(){
  ...
  local gen=$tmp/$FUNCNAME.gen.bash
