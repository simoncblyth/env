...
////////////////////////////////////////////////////////////////////////
//
// File:        DsChromaG4OpBoundaryProcess.cc
...
DsChromaG4OpBoundaryProcess::DsChromaG4OpBoundaryProcess(const G4String& processName,
                                               G4ProcessType type)
...
// DsChromaG4OpBoundaryProcess::DsChromaG4OpBoundaryProcess(const DsChromaG4OpBoundaryProcess &right)
// {
// }
...
DsChromaG4OpBoundaryProcess::~DsChromaG4OpBoundaryProcess(){}
...
//
G4VParticleChange*
DsChromaG4OpBoundaryProcess::PostStepDoIt(const G4Track& aTrack, const G4Step& aStep)
{
        theStatus = Undefined;
	...
	OldPolarization   = aParticle->GetPolarization();
        ...
        if (valid) {
          ...
          G4cerr << " DsChromaG4OpBoundaryProcess/PostStepDoIt(): "
...
G4ThreeVector
DsChromaG4OpBoundaryProcess::GetFacetNormal(const G4ThreeVector& Momentum,
...
void DsChromaG4OpBoundaryProcess::DielectricMetal()
{
        G4int n = 0;
...
void DsChromaG4OpBoundaryProcess::DielectricDielectric()
{
	G4bool Inside = false;
	G4bool Swap = false;
...
// ---------------
//
G4double DsChromaG4OpBoundaryProcess::GetMeanFreePath(const G4Track& ,
                                              G4double ,
...
G4double DsChromaG4OpBoundaryProcess::GetIncidentAngle() 
{
    G4double PdotN = OldMomentum * theFacetNormal;
...
G4double DsChromaG4OpBoundaryProcess::GetReflectivity(G4double E1_perp,
                                              G4double E1_parl,
