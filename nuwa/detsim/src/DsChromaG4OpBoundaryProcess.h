...
//
//
// $Id: DsChromaG4OpBoundaryProcess.hh,v 1.18 2008/11/07 17:59:37 gum Exp $
...
////////////////////////////////////////////////////////////////////////
//
// File:        DsChromaG4OpBoundaryProcess.hh
...
#ifndef DsChromaG4OpBoundaryProcess_h
#define DsChromaG4OpBoundaryProcess_h 1
...
enum DsChromaG4OpBoundaryProcessStatus {  Undefined,
...
class DsChromaG4OpBoundaryProcess : public G4VDiscreteProcess
{
...
private:
        ...
        // DsChromaG4OpBoundaryProcess& operator=(const DsChromaG4OpBoundaryProcess &right);

        // DsChromaG4OpBoundaryProcess(const DsChromaG4OpBoundaryProcess &right);
...
public: // Without description
        ...
        DsChromaG4OpBoundaryProcess(const G4String& processName = "OpBoundary",
...
public: // With description
	...
	G4OpticalSurfaceModel GetModel() const;
        ...
        DsChromaG4OpBoundaryProcessStatus GetStatus() const;
...
private:
	...
	DsChromaG4OpBoundaryProcessStatus theStatus;
...
inline
G4bool DsChromaG4OpBoundaryProcess::G4BooleanRand(const G4double prob) const
{
...
inline
G4bool DsChromaG4OpBoundaryProcess::IsApplicable(const G4ParticleDefinition& 
					               aParticleType)
{
...
inline
G4OpticalSurfaceModel DsChromaG4OpBoundaryProcess::GetModel() const
{
   return theModel;
}

inline
DsChromaG4OpBoundaryProcessStatus DsChromaG4OpBoundaryProcess::GetStatus() const
{
   return theStatus;
}

inline
void DsChromaG4OpBoundaryProcess::SetModel(G4OpticalSurfaceModel model)
{
   theModel = model;
}

inline
void DsChromaG4OpBoundaryProcess::ChooseReflection()
{
...
inline
void DsChromaG4OpBoundaryProcess::DoAbsorption()
{
...
inline
void DsChromaG4OpBoundaryProcess::DoReflection()
{
...
#endif /* DsChromaG4OpBoundaryProcess_h */
