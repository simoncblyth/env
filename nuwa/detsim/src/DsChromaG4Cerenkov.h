...
#ifndef DsChromaG4Cerenkov_h
#define DsChromaG4Cerenkov_h 1
...
class DsChromaG4Cerenkov : public G4VProcess
{
...
public: // Without description
	...
	DsChromaG4Cerenkov(const G4String& processName = "Cerenkov", 
...
inline 
G4bool DsChromaG4Cerenkov::IsApplicable(const G4ParticleDefinition& aParticleType)
{
...
inline 
void DsChromaG4Cerenkov::SetTrackSecondariesFirst(const G4bool state) 
{ 
	fTrackSecondariesFirst = state;
}

inline
void DsChromaG4Cerenkov::SetMaxBetaChangePerStep(const G4double value)
{
        fMaxBetaChange = value*perCent;
}

inline
void DsChromaG4Cerenkov::SetMaxNumPhotonsPerStep(const G4int NumPhotons) 
{ 
	fMaxPhotons = NumPhotons;
}

inline
void DsChromaG4Cerenkov::DumpPhysicsTable() const
{
...
inline
G4PhysicsTable* DsChromaG4Cerenkov::GetPhysicsTable() const
{
  return thePhysicsTable;
}

#endif /* DsChromaG4Cerenkov_h */
