...
#ifndef DsChromaG4Scintillation_h
#define DsChromaG4Scintillation_h 1
...
class DsChromaG4Scintillation : public G4VRestDiscreteProcess, public G4UImessenger
...
public: // Without description
	...
	DsChromaG4Scintillation(const G4String& processName = "Scintillation",
                          G4ProcessType type = fElectromagnetic);

	// DsChromaG4Scintillation(const DsChromaG4Scintillation &right);
...
public: // With description
        ...
        // DsChromaG4Scintillation Process has both PostStepDoIt (for energy 
...
inline 
G4bool DsChromaG4Scintillation::IsApplicable(const G4ParticleDefinition& aParticleType)
{
...
inline 
void DsChromaG4Scintillation::SetTrackSecondariesFirst(const G4bool state) 
{ 
	fTrackSecondariesFirst = state;
}

inline
G4bool DsChromaG4Scintillation::GetTrackSecondariesFirst() const
{
        return fTrackSecondariesFirst;
}

inline
void DsChromaG4Scintillation::SetScintillationYieldFactor(const G4double yieldfactor)
{
...
inline
G4double DsChromaG4Scintillation::GetScintillationYieldFactor() const
{
        return YieldFactor;
}

inline 
void DsChromaG4Scintillation::SetUseFastMu300nsTrick(const G4bool fastMu300nsTrick)
{
        FastMu300nsTrick = fastMu300nsTrick;
}

inline 
G4bool DsChromaG4Scintillation::GetUseFastMu300nsTrick() const
{
...
inline
void DsChromaG4Scintillation::SetScintillationExcitationRatio(const G4double excitationratio)
{
        ExcitationRatio = excitationratio;
}

inline
G4double DsChromaG4Scintillation::GetScintillationExcitationRatio() const
{
        return ExcitationRatio;
}

inline
G4PhysicsTable* DsChromaG4Scintillation::GetSlowIntegralTable() const
{
        return theSlowIntegralTable;
}

inline
G4PhysicsTable* DsChromaG4Scintillation::GetFastIntegralTable() const
{
        return theFastIntegralTable;
}

inline
G4PhysicsTable* DsChromaG4Scintillation::GetReemissionIntegralTable() const
{
 	return theReemissionIntegralTable;
}

inline
void DsChromaG4Scintillation::DumpPhysicsTable() const
{
...
#endif /* DsChromaG4Scintillation_h */
