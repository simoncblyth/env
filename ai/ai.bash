...
https://arxiv.org/ftp/arxiv/papers/2303/2303.10420.pdf
   ...
   ~/opticks_refs/Capability_Analysis_GPT3_2303_10420.pdf
...
https://dev.to/chainguns/openai-prompt-engineering-an-overview-58ia
...
Probably the simplest form of chain prompting is to first ask for the structure
of an article. Then you can tell ChatGPT to formulate the corresponding bullet
points. This method also saves time: If you notice that the AI is going down a
wrong path during the outline, you can make the necessary adjustments before
the full text is generated.

https://www.wired.com/story/11-tips-better-chatgpt-prompts/


https://www.reddit.com/r/GPT3/comments/ugn72o/do_you_use_any_special_characters_delimiters_with/
...
https://arxiv.org/pdf/2301.10016.pdf
