midas-env(){
  ...
  if [ "$MIDAS_UNAME" == "darwin" ]; then
      MIDAS_USER=blyth
  else
      MIDAS_USER=dayabaysoft
  fi
...
test $MIDAS_FOLDER/examples/experiment/expts/test $MIDAS_USER
test2 $MIDAS_FOLDER/examples/experiment/expts/test2 $MIDAS_USER
test3 $MIDAS_FOLDER/examples/experiment/expts/test3 $MIDAS_USER
